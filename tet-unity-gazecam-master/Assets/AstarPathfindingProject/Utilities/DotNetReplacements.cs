...
namespace Pathfinding.Util {
	 ...
	 * \version Since 3.6.4 this struct works properly on platforms with different endianness
	 */
	public struct Guid {
		...
		public Guid (byte[] bytes) {
			...
			if (!System.BitConverter.IsLittleEndian) _a = SwapEndianness (_a);
			if (!System.BitConverter.IsLittleEndian) _b = SwapEndianness (_b);
		}
